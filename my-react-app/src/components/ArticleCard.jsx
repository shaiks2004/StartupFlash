...
//   const image = imageFailed ? "" : getFeaturedImage(post)
...
//           <span className="article-category">{category || "Startup"}</span>
//           <h3
//             className="article-title"
//             dangerouslySetInnerHTML={{ __html: post.title?.rendered || "Untitled story" }}
//           />
//           <p
//             className="article-excerpt"
//             dangerouslySetInnerHTML={{
//               __html: post.excerpt?.rendered || "Read the latest startup and technology insights from StartupFlash."
//             }}
//           />
